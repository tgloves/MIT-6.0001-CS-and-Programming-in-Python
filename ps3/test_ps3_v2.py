...
def test_get_word_score():
    ...
    """
    failure=False
    # dictionary of words and scores. Changed weed and FORK from the original score bc they were wrong. This was a plant.
    words = {("", 7):0, ("it", 7):2, ("was", 7):54, ("weed", 6):144,
             ("scored", 7):351, ("WaYbILl", 7):735, ("Outgnaw", 7):539,
             ("fork", 7):209, ("FORK", 4):176}
...
def test_wildcard(word_list):
    ...
    # dictionary of words and scores WITH wildcards. Changed score of c*ws.
    words = {("h*ney", 7):290, ("c*ws", 6):144, ("wa*ls", 7):203}
    for (word, n) in words.keys():
        score = get_word_score(word, n)
        if score != words[(word, n)]:
